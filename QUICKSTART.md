...
### 🖥️ Вариант 1: Графический интерфейс (GUI) - РЕКОМЕНДУЕТСЯ! ✨

**Самый простой способ для новых пользователей!**
...
- ⚙️ Настройка всех параметров в одном окне
- 📊 Журнал обработки в реальном времени
- 🎯 Индикатор прогресса

📖 **Полная документация GUI:** [GUI.md](GUI.md)
...
**По умолчанию:** все файлы транскрипции сохраняются в директорию **`./output/`**

Директория создается автоматически, если не существует.

**Примеры файлов после обработки:**
```
output/
├── transcription_20260206_143025.json  ← Полный отчет с метаданными
├── transcription_20260206_143025.csv   ← Таблица сегментов
└── transcription_20260206_143025.txt   ← Читаемый транскрипт
```
...
Подробнее о форматах: [README.md](README.md#форматы-вывода)
